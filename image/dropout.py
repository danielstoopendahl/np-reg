...
def main():
    ...
    # model.load_state_dict(torch.load('models/resnet1_dropout.pth'))
    ...
    torch.save(model.state_dict(), "models/resnet1_dropout.pth")
    print("Model saved to models/resnet1_dropout.pth")
