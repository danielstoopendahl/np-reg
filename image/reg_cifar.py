...
# python np_reg.py --np-reg-lambda=1e-2 --batch-size=128 | tee out401.txt; python np_reg.py --np-reg-lambda=1e-2 --batch-size=256 | tee out402.txt; python np_reg.py --np-reg-lambda=1e-2 --batch-size=512 | tee out403.txt; python np_reg.py --np-reg-lambda=3e-2 --batch-size=128 | tee out404.txt; python np_reg.py --np-reg-lambda=3e-2 --batch-size=256 | tee out405.txt; python np_reg.py --np-reg-lambda=3e-2 --batch-size=512 | tee out406.txt;
# python np_reg.py --np-reg-lambda=1e-1 --batch-size=128 | tee out407.txt; python np_reg.py --np-reg-lambda=1e-1 --batch-size=256 | tee out408.txt; python np_reg.py --np-reg-lambda=1e-1 --batch-size=512 | tee out409.txt; python np_reg.py --np-reg-lambda=3e-1 --batch-size=128 | tee out410.txt; python np_reg.py --np-reg-lambda=3e-1 --batch-size=256 | tee out411.txt; python np_reg.py --np-reg-lambda=3e-1 --batch-size=512 | tee out412.txt;
# python np_reg.py --np-reg-lambda=1 --batch-size=128 | tee out413.txt; python np_reg.py --np-reg-lambda=1 --batch-size=256 | tee out414.txt; python np_reg.py --np-reg-lambda=1 --batch-size=512 | tee out415.txt; python np_reg.py --np-reg-lambda=3 --batch-size=128 | tee out416.txt; python np_reg.py --np-reg-lambda=3 --batch-size=256 | tee out417.txt; python np_reg.py --np-reg-lambda=3 --batch-size=512 | tee out418.txt;
