...
HIDDEN_DIM = 16384 # [256, 2048, 1024, 2048, 4096, 8192, 16384]
...
# python np_reg.py --weight-decay=1e-6 --batch-size=4096 | tee out229.txt; python np_reg.py --weight-decay=1e-6 --batch-size=1024 | tee out230.txt; python np_reg.py --weight-decay=1e-6 --batch-size=2048 | tee out231.txt; python np_reg.py --weight-decay=1e-4 --batch-size=4096 | tee out241.txt; python np_reg.py --weight-decay=1e-4 --batch-size=1024 | tee out242.txt; python np_reg.py --weight-decay=1e-4 --batch-size=2048 | tee out243.txt; python np_reg.py --dropout=0.2 --batch-size=4096 | tee out253.txt; python np_reg.py --dropout=0.2 --batch-size=1024 | tee out254.txt; python np_reg.py --dropout=0.2 --batch-size=2048 | tee out255.txt; python np_reg.py --o-reg-lambda=1e-1 --batch-size=256 | tee out300.txt; python np_reg.py --o-reg-lambda=1e-1 --batch-size=512 | tee out301.txt; python np_reg.py --o-reg-lambda=1e-1 --batch-size=1024 | tee out302.txt; python np_reg.py --o-reg-lambda=3e-1 --batch-size=256 | tee out303.txt; python np_reg.py --o-reg-lambda=3e-1 --batch-size=512 | tee out314.txt;
# python np_reg.py --weight-decay=3e-6 --batch-size=1024 | tee out232.txt; python np_reg.py --weight-decay=3e-6 --batch-size=2048 | tee out233.txt; python np_reg.py --weight-decay=3e-6 --batch-size=4096 | tee out234.txt; python np_reg.py --weight-decay=3e-4 --batch-size=4096 | tee out244.txt; python np_reg.py --weight-decay=3e-4 --batch-size=1024 | tee out245.txt; python np_reg.py --weight-decay=3e-4 --batch-size=2048 | tee out246.txt; python np_reg.py --dropout=0.25 --batch-size=4096 | tee out1024.txt; python np_reg.py --dropout=0.25 --batch-size=1024 | tee out257.txt; python np_reg.py --dropout=0.25 --batch-size=2048 | tee out258.txt; python np_reg.py --o-reg-lambda=3e-1 --batch-size=1024 | tee out304.txt; python np_reg.py --o-reg-lambda=1 --batch-size=256 | tee out305.txt; python np_reg.py --o-reg-lambda=1 --batch-size=512 | tee out315.txt; python np_reg.py --o-reg-lambda=1 --batch-size=1024 | tee out306.txt; python np_reg.py --o-reg-lambda=3 --batch-size=256 | tee out307.txt;
# python np_reg.py --weight-decay=1e-5 --batch-size=2048 | tee out235.txt; python np_reg.py --weight-decay=1e-5 --batch-size=4096 | tee out236.txt; python np_reg.py --weight-decay=1e-5 --batch-size=1024 | tee out237.txt; python np_reg.py --dropout=0.1 --batch-size=4096 | tee out247.txt; python np_reg.py --dropout=0.1 --batch-size=1024 | tee out248.txt; python np_reg.py --dropout=0.1 --batch-size=2048 | tee out249.txt; python np_reg.py --dropout=0.3 --batch-size=4096 | tee out259.txt; python np_reg.py --dropout=0.3 --batch-size=1024 | tee out260.txt; python np_reg.py --dropout=0.3 --batch-size=2048 | tee out261.txt; python np_reg.py --o-reg-lambda=3 --batch-size=512 | tee out317.txt; python np_reg.py --o-reg-lambda=3 --batch-size=1024 | tee out308.txt; python np_reg.py --o-reg-lambda=10 --batch-size=256 | tee out309.txt; python np_reg.py --o-reg-lambda=10 --batch-size=1024 | tee out319.txt; python np_reg.py --o-reg-lambda=10 --batch-size=512 | tee out318.txt; python np_reg.py --o-reg-lambda=30 --batch-size=256 | tee out310.txt; 
