...
X_MEAN_NORM = 17.156349
X_STD_NORM = 2.957727

def parse_args():
    parser = argparse.ArgumentParser(description="Train an SNNN on UCI HAR")
...
def main():
    ...
    val_subjects = folds[0]
    train_subjects = np.concatenate([folds[j] for j in range(5) if j != 0])
